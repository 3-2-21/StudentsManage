  ...
  %>
     ...
     <form action="updateServlet" >
      ...
      <table  style="background-size: 100%; opacity: 0.8; filter: alpha(opacity = 100)"   bgcolor="lightgrey" border="0" 
           ...
           <tr>			
            <td align="center"><h1>修改新生信息</h1> </td>
           </tr> 
            <tr>			
            <td align="center"> 学&nbsp;&nbsp;&nbsp;&nbsp;号：<input type="text" name = "sno" readonly="readonly" value="<%=student.getSno() %>"/></td>
            </tr>                
            ...
            <td align="center">  电&nbsp;&nbsp;&nbsp;&nbsp;话：<input type="text"   name="sphone" value="<%=student.getSphone() %>"/></td>
             ...
             <tr>			
            <td  align="center" ><input type="submit" value="修改"/>&nbsp;&nbsp;&nbsp;<a href="queryByPage"><input type = "button" value ="返回" /></a>
