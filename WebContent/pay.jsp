...
<%@page import="student.inform.Pay"%>
...
.footer a {
 ...
 <div class="header">
   ...
   <div class="rightcolumn ">
     ...
     <tr><th colspan="3" style="text-align: center;font-size: 20px;">缴费信息列表</th></tr>     
    ...
    <div class="footer">  
     <a href="queryPayByPage?currentPage=1">首页</a>
     <a href="queryPayByPage?currentPage=<%=p.getCurrentPage()-1%>">上一页</a>
     <a href="queryPayByPage?currentPage=<%=p.getCurrentPage()+1%>">下一页</a>
     <a href="queryPayByPage?currentPage=<%=p.getTotalPage()%>">尾页</a>    
    </div>
    </div>
    </div>
</div>
